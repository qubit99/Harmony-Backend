...
Revision ID: 86f7f375efb6
Revises: 
Create Date: 2021-05-11 23:34:13.915214
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['sexual_orientation_id'], ['sexual_orientation.id'], ondelete='SET NULL'),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('img_ref', sa.String(), nullable=True),
    sa.Column('img_src', sa.String(), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['user_account.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('img_id')
    )
    op.create_table('user_passions',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=True),
    sa.Column('passion_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['passion_id'], ['passions.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user_id'], ['user_account.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
